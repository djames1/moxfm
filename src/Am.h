...
FmCallbackProc appInstallCb, appOpenCb, appEditCb, appRemoveCb, appSaveCb,
    appLoadCb, appOpenFileWinCb, appCloseCb, appboxNewCb, appExitCb,
    appEditCfgCb;
...
Boolean appConvProc(Widget w, Atom *selection, Atom *target, Atom *type_return,
                    XtPointer *value_return, unsigned long *length_return,
                    int *format_return);
void appDropFinish(Widget w, XtPointer client_data, XtPointer call_data);
void startAppDrag(Widget w, XEvent *event, String *params,
                  Cardinal *num_params);
void handleAppDrop(Widget w, XtPointer client_data, XtPointer call_data);
void appTransProc(Widget w, XtPointer client_data, Atom *seltype, Atom *type,
                  XtPointer value, unsigned long *length, int format);
void handlePushDrop(Widget w, XtPointer client_data, XtPointer call_data);
void pushTransProc(Widget w, XtPointer client_data, Atom *seltype, Atom *type,
                   XtPointer value, unsigned long *length, int format);
void startDTIconDrag(Widget w, XEvent *event, String *params,
                     Cardinal *num_params);
...
void makeObjectButton(AppSpecRec *awi, int objType, char *buffer,
                      unsigned long len);
