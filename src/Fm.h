...
typedef struct _FileWindowRec {
  ...
  int update;
  SortType sort_type;
  Widget shell, cont, menu_bar, form, dirfield, status, scrolled, icon_box,
      scrollbar;
  Widget var_file_items[NVARITEMS];
  Widget filePopup, dirPopup, execPopup, formPopup, dirfieldPopup;
  Widget dirs_first_button, icon_view_button, text_view_button,
      sort_name_button, sort_size_button, sort_date_button;
...
FileWindowRec *createFileWindow(String path, FileWindowRec *parent, FILE *fin,
                                GeomRec *geom);
...
FmCallbackProc newFileCb, mkDirCb, selectCb, selectAllCb, deselectCb,
    editFileConfCb, editFileMonCb, fileIconsCb, fsInfoCb, fileTextCb,
    fileSortNameCb, fileSortSizeCb, fileSortMTimeCb, fileShowDirsCb,
    fileDirsFirstCb, fileCloseCb, goHomeCb, fileUpCb, fileShowHiddenCb,
    fileEditCb, fileExecCb, commandCb, fileViewCb, fileActionCb, filePropsCb,
    dirOpenCb, fileExitCb, dirFilterCb, mgcHeadersCb, viewTypeCb, sortTypeCb,
    showHiddenCb, showDirsCb, dirsFirstCb;
...
FmActionProc fileBeginDrag, treeOpenDir, fileExecAction, resetCursor, filePopup,
    parentsPopup, dirPopup;
...
void fileSelectCb(Widget w, XEvent *event, String *params,
                  Cardinal *num_params);
void fileToggleCb(Widget w, XEvent *event, String *params,
                  Cardinal *num_params);
void selectBlockCb(Widget w, XEvent *event, String *params,
                   Cardinal *num_params);
...
void overwriteDialog(SelFileNamesRec *files, String filename, String op,
                     int dirflag);
...
Boolean fileConvProc(Widget w, Atom *selection, Atom *target, Atom *type_return,
                     XtPointer *value_return, unsigned long *length_return,
                     int *format_return);
void fileDropFinish(Widget w, XtPointer client_data, XtPointer call_data);
void startFileDrag(Widget w, XEvent *event, String *params,
                   Cardinal *num_params);
void handleFileWinDrop(Widget w, XtPointer client_data, XtPointer call_data);
void fileTransProc(Widget w, XtPointer client_data, Atom *seltype, Atom *type,
...
Widget *createFloatingMenu(String menu_name, MenuItemRec *items,
